...
describe("VolmexController - Leverage", function () {
  ...
  describe("2x and 5x leverage", () => {
    this.beforeEach(async () => {
      ...
      await (
        await volatilities["ETH2x"].approve(controller.address, "1000000000000000000")
      ).wait();
      await (
        await inverseVolatilities["ETH2x"].approve(controller.address, "1000000000000000000")
      ).wait();
      await (
        await volatilities["BTC2x"].approve(controller.address, "1000000000000000000")
      ).wait();
      await (
        await inverseVolatilities["BTC2x"].approve(controller.address, "1000000000000000000")
      ).wait();
      await (
        await volatilities2["ETH5x"].approve(controller2.address, "1000000000000000000")
      ).wait();
      await (
        await inverseVolatilities2["ETH5x"].approve(controller2.address, "1000000000000000000")
      ).wait();
      await (
        await volatilities2["BTC5x"].approve(controller2.address, "1000000000000000000")
      ).wait();
      await (
    ...
    it("Should swap volatility tokens (2x)", async () => {
      ...
      await (
        await inverseVolatilities["ETH2x"].approve(
          controller.address,
      ...
      await (
        await volatilities["ETH2x"].approve(controller.address, "20000000000000000000")
      ).wait();
    ...
    it("Should swap between multiple pools (2x)", async () => {
      ...
      await (
        await inverseVolatilities["BTC2x"].approve(
          controller.address,
          "599999999000000000000000000"
        )
      ).wait();
    ...
    it("Should swap volatility tokens (5x)", async () => {
      ...
      await (
        await inverseVolatilities2["ETH5x"].approve(
          controller2.address,
          "599999999000000000000000000"
        )
      ).wait();
      ...
      await (
        await volatilities2["ETH5x"].approve(controller2.address, "20000000000000000000")
      ).wait();
    ...
    it("Should swap collateral to volatility (5x)", async () => {
      ...
      await (
        await collateral["DAI"].approve(controller2.address, "1500000000000000000000")
      ).wait();
    ...
    it("Should swap between multiple pools (5x)", async () => {
      ...
      await (
        await inverseVolatilities2["BTC5x"].approve(
          controller2.address,
          "599999999000000000000000000"
        )
      ).wait();
